...
public class JakDojadePrompts
{
        ...
        [Description("End location")] string endLocation)
    {
        return [
            new ChatMessage(ChatRole.System, @"
                ...
                2. Use jd://cities resource to get json with all cities, extract matching normalizedNames
        ...
        [Description("Line name")] string line)
    {
        return [
            ...
            2. Use jd://cities resource to get json with all cities, extract normalizedName from matching city and collect all operatorIds for that city
